...
export function BrandColors() {
  return (
    <AlertWrapper>
      <Alert brandColor="primary-light1">primary-light1</Alert>
      <Alert brandColor="primary-light2">primary-light1</Alert>
      <Alert brandColor="common-grey-light">common-grey-light</Alert>
    </AlertWrapper>
  );
}
